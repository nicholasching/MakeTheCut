/**
 * Copies MarkData -> marks with ids `25_*`, MarkData24 -> `24_*`.
...
async function main() {
  ...
  await copyYear(databases, "MarkData", "25");
  await copyYear(databases, "MarkData24", "24");
  console.log("migrate-marks done.");
}

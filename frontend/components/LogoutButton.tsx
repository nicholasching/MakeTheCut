                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="absolute top-10 right-10">
                    <Dialog>
                        <DialogTrigger asChild>
                            <button
                                type="button"
                                className="flex size-12 cursor-pointer items-center justify-center md:size-10"
                                aria-label="Account menu"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="white" className="size-full transition-colors duration-200 hover:fill-neutral-400 hover:scale-105">
